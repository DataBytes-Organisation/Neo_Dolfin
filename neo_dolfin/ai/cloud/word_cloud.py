...
def generate(data_with_level, level, mode='default', preprocess=True, whether_jsonify=True):
    """
    ...
    def preprocess_data(data, data_level):
        ...
        """
        cleaned_data = data[data['Expenditure Level'] == data_level].copy()
        return cleaned_data
    ...
    wordcloud = WordCloud(width=600, height=300, background_color='white').generate_from_frequencies(freq_dict)
